...
export default function ActivitiesPage() {
  ...
  const blocks = (t("activities.blocks", { returnObjects: true }) as Array<any>) || [];

  return (
    <>
      <Helmet>
        <title>{t("activities.seo.title")} · SHD Technology</title>
        <meta name="description" content={t("activities.seo.description")} />
      </Helmet>
